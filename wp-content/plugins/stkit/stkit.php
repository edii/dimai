...
/*
Plugin Name: ST Kit
Plugin URI: http://stkit.net
Description: Extended functionality for Premium WordPress themes created by stkit.net
Author: StrictThemes
Author URI: http://stkit.net/to/portfolio
Version: 1.7.2
...
===============================================*/
	...
	$st_UpdateChecker = PucFactory::buildUpdateChecker( 'http://stkit.net/repo/?action=get_metadata&slug=stkit', __FILE__, 'stkit' );
